    ...
    MuiTextField: {
      styleOverrides: {
        root: {
          '& .MuiOutlinedInput-root': {
            transition: 'all 0.2s ease-in-out',
            '&:hover': { boxShadow: '0 2px 8px rgba(37, 99, 235, 0.08)' },
            '&.Mui-focused': { boxShadow: '0 2px 8px rgba(37, 99, 235, 0.12)' }
          }
        }
      }
    },
    MuiPaper: {
      styleOverrides: {
        root: {
          transition: 'all 0.2s ease-in-out',
          boxShadow: '0 1px 3px rgba(37, 99, 235, 0.05)',
          '&:hover': { boxShadow: '0 8px 24px rgba(37, 99, 235, 0.08)' }
        }
      }
    },
    MuiAppBar: {
...
function App() {
  ...
  // DUMMY AUTH: Check localStorage instead of Firebase
  useEffect(() => {
